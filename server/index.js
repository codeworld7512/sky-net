...
/* This line of code is converting the import.meta.url from a file URL to a file path string and storing it in the __filename constant variable, which can then be 
used to reference the current module's file path within the local file system. */
const __dirname = path.dirname(__filename);
/* This line of code is getting the directory name of the current module's file path and storing it in the __dirname constant variable, which can then be used 
to reference the current module's directory path within the local file system. */
dotenv.config();
/* This line of code is loading the environment variables from the .env file into the process.env object. */
const app = express();
/* This line of code is creating an Express application and storing it in the app constant variable, which can then be used to reference the Express application. */
...
/* This line of code is parsing the incoming request bodies in a middleware before your handlers, available under the req.body property. */
app.use(cors());
/* This line of code is enabling CORS for all routes. */
